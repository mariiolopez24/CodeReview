  ...
  return (
    <div className="min-h-screen bg-[#0d1117]">
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-[#e6edf3]">Code Review con IA</h1>
          <p className="text-[#8b949e] mt-1">Pega tu código y obtén un análisis completo de seguridad, bugs y performance en segundos.</p>
        </div>
